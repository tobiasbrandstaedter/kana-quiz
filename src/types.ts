...
export type StatsFilter = 'all' | 'hiragana' | 'katakana'
export type StatsSortCol = 'kana' | 'acc' | 'seen' | 'errors' | 'time'
export interface StatsSort { col: StatsSortCol; dir: 'asc' | 'desc' }
